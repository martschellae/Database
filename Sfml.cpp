...
int main()
{
    ...
    std::cout << createRandomKey(1, 128) << "\n";
    std::cout << vignere(verschl, 0, createRandomKey(1, 128)) << "\n \n";
    std::cout << vignere(vignere(verschl, 0, createRandomKey(1, 128)), 1, createRandomKey(1, 128));
